...
use App\Entity\EstimateTabPerformance;
 ...
 */
class EstimateTabPerformanceRepository extends ServiceEntityRepository
{
    public function __construct(ManagerRegistry $registry)
    {
        parent::__construct($registry, EstimateTabPerformance::class);
    }
