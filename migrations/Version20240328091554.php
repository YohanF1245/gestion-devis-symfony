 ...
 */
final class Version20240328091554 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE business (id BINARY(16) NOT NULL COMMENT \'(DC2Type:uuid)\', user_id_id BINARY(16) NOT NULL COMMENT \'(DC2Type:uuid)\', siret INT NOT NULL, logo VARCHAR(255) DEFAULT NULL, INDEX IDX_8D36E389D86650F (user_id_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE users (id BINARY(16) NOT NULL COMMENT \'(DC2Type:uuid)\', mail VARCHAR(128) NOT NULL, signature VARCHAR(255) DEFAULT NULL, pass VARCHAR(128) NOT NULL, creation_date DATETIME NOT NULL, update_date DATETIME DEFAULT NULL, pseudo VARCHAR(128) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
