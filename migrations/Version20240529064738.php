...
final class Version20240529064738 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE dress_estimate (id BINARY(16) NOT NULL COMMENT \'(DC2Type:uuid)\', user_id_id BINARY(16) NOT NULL COMMENT \'(DC2Type:uuid)\', client_id_id BINARY(16) NOT NULL COMMENT \'(DC2Type:uuid)\', creation_date DATETIME NOT NULL, estimate_number INT NOT NULL, validity INT DEFAULT NULL, expiration_date DATETIME NOT NULL, intitule VARCHAR(128) NOT NULL, free_zone LONGTEXT DEFAULT NULL, accompte INT DEFAULT NULL, discount INT DEFAULT NULL, INDEX IDX_4E0EB682DC2902E0 (client_id_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
