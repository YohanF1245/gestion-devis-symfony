...
final class Version20240529064738 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE business (id BINARY(16) NOT NULL COMMENT \'(DC2Type:uuid)\', user_id_id BINARY(16) NOT NULL COMMENT \'(DC2Type:uuid)\', siret VARCHAR(14) NOT NULL, logo VARCHAR(255) DEFAULT NULL, business_name VARCHAR(255) NOT NULL, code_ape VARCHAR(255) NOT NULL, code_tva VARCHAR(255) DEFAULT NULL, rib VARCHAR(255) DEFAULT NULL, UNIQUE INDEX UNIQ_8D36E3826E94372 (siret), INDEX IDX_8D36E389D86650F (user_id_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE dress_estimate (id BINARY(16) NOT NULL COMMENT \'(DC2Type:uuid)\', is_valid TINYINT(1) NOT NULL, total DOUBLE PRECISION NOT NULL, user_id_id BINARY(16) NOT NULL COMMENT \'(DC2Type:uuid)\', client_id_id BINARY(16) NOT NULL COMMENT \'(DC2Type:uuid)\', creation_date DATETIME NOT NULL, estimate_number INT NOT NULL, validity INT DEFAULT NULL, expiration_date DATETIME NOT NULL, intitule VARCHAR(128) NOT NULL, free_zone LONGTEXT DEFAULT NULL, accompte INT DEFAULT NULL, discount INT DEFAULT NULL, INDEX IDX_4E0EB682DC2902E0 (client_id_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE outcome (id BINARY(16) NOT NULL COMMENT \'(DC2Type:uuid)\', business_id_id BINARY(16) NOT NULL COMMENT \'(DC2Type:uuid)\', outcome_date DATETIME NOT NULL, outcome_amount DOUBLE PRECISION NOT NULL, recipe_link VARCHAR(255) DEFAULT NULL, name VARCHAR(255) NOT NULL, INDEX IDX_30BC6DC21A579E8 (business_id_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE performance (id BINARY(16) NOT NULL COMMENT \'(DC2Type:uuid)\', user_id_id BINARY(16) NOT NULL COMMENT \'(DC2Type:uuid)\', quantity INT NOT NULL, designation VARCHAR(255) NOT NULL, tax DOUBLE PRECISION DEFAULT NULL, pirce DOUBLE PRECISION NOT NULL, unit VARCHAR(64) DEFAULT NULL, INDEX IDX_82D796819D86650F (user_id_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE users (id BINARY(16) NOT NULL COMMENT \'(DC2Type:uuid)\', is_verified TINYINT(1), email VARCHAR(180) NOT NULL, roles JSON NOT NULL COMMENT \'(DC2Type:json)\', password VARCHAR(255) NOT NULL, pseudo VARCHAR(255) NOT NULL, signature VARCHAR(255) DEFAULT NULL, creation_date DATETIME NOT NULL, update_date DATETIME DEFAULT NULL, UNIQUE INDEX UNIQ_IDENTIFIER_EMAIL (email), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE dress_estimate ADD CONSTRAINT FK_4E0EB682DC2902F0 FOREIGN KEY (user_id_id) REFERENCES users (id)');
        ...
        $this->addSql('ALTER TABLE performance ADD CONSTRAINT FK_82D796819D86650F FOREIGN KEY (user_id_id) REFERENCES users (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE performance DROP FOREIGN KEY FK_82D796819D86650F');
